...
namespace Assets._Project.Develop.Runtime.UI.Gameplay.ResultsPopups
{
    public class WinPopupView : PopupViewBase
    {
        ...
        [SerializeField] private Transform _tapToContinueTextTransform;
        ...
        protected override void ModifyShowAnimation(Sequence animation)
        {
            ...
            PulseEffectFor(_tapToContinueTextTransform, 1.2f, 0.5f);
        }

        private void PulseEffectFor(Transform target, float pulseScale, float duration)
        {
            Vector3 originalScale = target.localScale;

            Tweener animation = _tapToContinueTextTransform
                .DOScale(originalScale * pulseScale, duration)
